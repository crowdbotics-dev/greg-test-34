"""
Django settings for greg_test_34 project.
...
ROOT_URLCONF = 'greg_test_34.urls'
...
WSGI_APPLICATION = 'greg_test_34.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Greg Test Support <support@greg-test-34.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "greg_test_34 API",
    "DESCRIPTION": "API documentation for greg_test_34 App",
    "VERSION": "v1",
}
